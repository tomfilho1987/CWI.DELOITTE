Public Class NotaFiscalEditar
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Try
                ...
                hdnId.Value = Convert.ToString(Request("Id"))
    ...
    Private Sub Exibir()
        ...
        notaFiscal.IdNotaFiscal = hdnId.Value

        Dim nvc As NameValueCollection = notaFiscal.ObterNota()

        If nvc.Item("CLI_ID").Trim() = "" Then
            drpCliente.SelectedIndex = 0
        Else
            drpCliente.SelectedValue = nvc.Item("CLI_ID").Trim()
        End If

        If nvc.Item("FOR_ID").Trim() = "" Then
            drpFornecedor.SelectedIndex = 0
        Else
            drpFornecedor.SelectedValue = nvc.Item("FOR_ID").Trim()
        End If

        If nvc.Item("PROD_ID").Trim() = "" Then
            drpProduto.SelectedIndex = 0
        Else
            drpProduto.SelectedValue = nvc.Item("PROD_ID").Trim()
        End If

        txtQuantidade.Text = nvc.Item("NF_QTDE").Trim()
